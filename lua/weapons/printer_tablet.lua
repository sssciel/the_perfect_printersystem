...
-- Big thanks for Alydus for this model
-- Не спиздил, а грамотно использовал модель
...
SWEP.Author = "enmanish"
SWEP.Instructions = ""
SWEP.Contact = ""
SWEP.Purpose = ""
SWEP.Spawnable = true
SWEP.AdminOnly = false
SWEP.Category = "enmanish"
...
function SWEP:PrimaryAttack()
	if SERVER then
		if kd > CurTime() then return end
		self:GetOwner():SendLua("surface.PlaySound(\"common/warning.wav\")")
		self:GetOwner():SendLua("RunConsoleCommand(\"printer_panel\")")
		kd = CurTime() + 2
	end
end
